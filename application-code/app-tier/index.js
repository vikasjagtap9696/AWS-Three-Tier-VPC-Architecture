...
app.get('/students',(req,res)=>{
    transactionService.getAllStudents(function (results) {
        res.json({ result: results });
    });
});

app.post('/students',(req,res)=>{
    transactionService.addStudent(req.body, function(err){
...
app.put('/students/:id',(req,res)=>{
    transactionService.updateStudent(req.params.id, req.body, function(err){
        if (err) return res.status(400).json({ message: err.message });
...
app.delete('/students/:id',(req,res)=>{
    transactionService.deleteStudent(req.params.id, function(err){
        if (err) return res.status(400).json({ message: err.message });
